...
ROOT_DIR = environ.Path(__file__) - 3  # (juriestargram/config/settings/base.py - 3 = juriestargram/)
APPS_DIR = ROOT_DIR.path('juriestargram')
...
MIGRATION_MODULES = {
    'sites': 'juriestargram.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Jurie Coders""", 'ju-rie@hanmail.net'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'juriestargram.users.adapters.SocialAccountAdapter'
